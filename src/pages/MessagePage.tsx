  ...
  return (
    ...
    <HeaderDecoy2 />
        ...
        <div className={styles.container}>
          <Box sx={{display:"grid", gridTemplateColumns:"5rem 14rem", justifyContent:"center", alignItems:"center", width:"100%", height:"7.5rem", color:"#fff", background:colors.secondary_blue_softer}}>
          ...
          <Box sx={{display:"grid", gridTemplateColumns:"5rem 14rem", justifyContent:"center", alignItems:"center", width:"100%", height:"7.5rem", color:"#fff", background:colors.secondary_blue_soft}}>
          ...
          <Box sx={{display:"grid", gridTemplateColumns:"5rem 14rem", justifyContent:"center", alignItems:"center", width:"100%", height:"7.5rem", color:"#fff", background:colors.secondary_blue}}>
